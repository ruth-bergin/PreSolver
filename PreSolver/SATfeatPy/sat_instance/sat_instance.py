from SATfeatPy.feature_computation import preprocessing, parse_cnf, active_features, base_features, local_search_probing, \
    graph_features_ansotegui, graph_features_manthey_alfonso, more_graph_features
from SATfeatPy.feature_computation.dpll import DPLLProbing
from SATfeatPy.sat_instance import write_to_file
...
class SATInstance:
    ...
    def __init__(self, input_cnf, preprocess=True, verbose=False, preprocess_tmp=True):
        ...
        # parse the cnf file
        if self.verbose:
            print(f"Parsing cnf file {self.path_to_cnf}")
